...
function filterTaskTypeOptions(col, oldOptions) {
    debugger
    if (taskPageInfo.TASKTYPEOPTIONS) return taskPageInfo.TASKTYPEOPTIONS;
    let info = $DS.getCtrl('GRID_任务列表').info;
    ...
    //引用数据过滤条件
    var colSqlFilter = "APPID='${V.URL_APPNAME}'  AND MOF_DEP_CODE = '${V.USER_deptCode}'";
    ...
    taskPageInfo.TASKTYPEOPTIONS = options;
    return options;
