...
public class ExcelToHtml {
    @ResponseBody
    @RequestMapping("/toHtmlTest")
    public String toHtmlTest(HttpServletRequest request, MultipartFile multipartFile) {
...
//    InputStream in = multipartFile.getInputStream();
        ...
        String html = readExcelToHtml(file, true);
        if (f.delete()) {
     ...
     */
    public static String readExcelToHtml(File file, boolean isWithStyle) {
