/*<div className="labelalign">
    <p>
        ...
        <span style="color:#cef3ff;font-size:10px;">${SZB}%<br/></span>
...
function changeData(checked) {
    if(checked=="收入增幅"){
        $("#ctrl_718120-191631659").attr("dv_labelreg","<div className=\"labelalign\">\n" +
            ...
            "        <span style=\"color:#cef3ff;font-size:10px;\">${SMPERIOD_ZZL_YB}%<br/></span>\n" +
            "        <span style=\"color:#cef3ff;font-size:10px;\">第${YEARDCT_DESC}名</span>\n" +
            "    </p>\n" +
            "    <div>")
