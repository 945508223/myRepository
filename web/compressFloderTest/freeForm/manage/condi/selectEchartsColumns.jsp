...
<head>
    ...
    <script type="text/javascript" src="selectEchartsColumns.js"></script>
...
<div id="contentDiv" style="overflow: auto;background-color: #f6f7fd;" class="layui-col-md10">
    ...
    <div id="right_Table" style="width: calc(35%);float: right; position: relative;">
        <div style='float:left;position: absolute;left: 10px;top: 10px;z-index: 999999999999;'><h3>当前表字段(双击或拖拽):</h3>
        </div>
