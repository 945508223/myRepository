...
<head>
    ...
    <script src="../../../../static/online_editor/js/xml-fold.js"></script>
    <script src="../../../../static/online_editor/js/matchtags.js"></script>
    <!-- 高亮光标所在的行 -->
...
<div id="content" class="ww">
    <form id="form" class="hh">
        <textarea id="code-html" name="code" class="form-control"></textarea>
    </form>
</div>
