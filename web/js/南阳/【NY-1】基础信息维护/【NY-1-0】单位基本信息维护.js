...
function init() {
  ...
  /*  if (insType == "add") {
        ...
        sourceInfo.filter += "and TASKMONTH='${V.currentMonth}' and PERSONID not in(select PERSONID FROM NY_PAYROLL WHERE TASKMONTH='${V.currentMonth}' and year='${V.USER_currentyear}'"
    }*/
