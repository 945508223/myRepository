...
function leftBtn_insert_click() {
    ...
    $DS.showPage("freeFromView.jsp?PAGEID=3A802A254E524D7AB1D73BDBFD752E00&PAGETITLE=即席分析新增修改&APPID=BMP&pageType_=isInsert", "新增分类", "40%", "50%");
}
...
function leftBtn_update_click() {
    ...
    $DS.showPage("freeFromView.jsp?PAGEID=3A802A254E524D7AB1D73BDBFD752E00&PAGETITLE=即席分析新增修改&APPID=BMP&pageType_=isUpdate", "修改分类", "40%", "50%");
}
...
function rightBtn_insert_click() {
    ...
    ///freeForm/freeFromView.jsp?PAGEID=3A802A254E524D7AB1D73BDBFD752E00&PAGETITLE=【Z1-1-1】即席分析新增修改&APPID=BMP
    $DS.showPage("freeFromView.jsp?PAGEID=3A802A254E524D7AB1D73BDBFD752E00&PAGETITLE=即席分析新增修改&APPID=BMP&pageType_=grid_isInsert", "新增页面", "40%", "50%");
}
...
function rightBtn_update_click() {
    ...
    $DS.showPage("freeFromView.jsp?PAGEID=3A802A254E524D7AB1D73BDBFD752E00&PAGETITLE=即席分析新增修改&APPID=BMP&pageType_=grid_isUpdate", "新增页面", "40%", "50%");
}
